...
export class TtsSocket {
     ...
     * ```
     */
    public on<T extends keyof TtsSocket.EventHandlers>(event: T, callback: TtsSocket.EventHandlers[T]): void {
    ...
    protected sendJson(payload: Respeecher.tts.ContextfulGenerationRequest | Respeecher.tts.CancellationRequest): void {
